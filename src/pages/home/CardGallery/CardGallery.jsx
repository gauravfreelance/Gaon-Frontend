...
import { GridImage, GridImage1, GridImage2, GridImage3 } from '../../../public/Images'
...
const CardGallery = () => {
    ...
    useEffect(() => {
		fetchJSON("challenges?populate=*", "GET", "").then((data) => {
                    ...
                    <div className="card" key={index}>
                        ...
                        <div className="card-content">
                            ...
                            <p className="card-description">
                                {/* {i.attributes.Desc} ... {" "} */}
                                <span style={{ color: "#0CC5FF" }} onClick={() => navigate(`challenges-item/${i?.id}`)}> Read More</span>
                            </p>
                        </div>
                    </div>
                ))}
